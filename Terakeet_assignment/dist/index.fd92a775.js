...
var _dataDataJsonDefault = _parcelHelpers.interopDefault(_dataDataJson);
// =============== LOCAL JSON FILE
let numbersArray = [];
_dataDataJsonDefault.default.data.forEach((obj, i) => {
...
let app = new Vue({
  ...
  methods: {
    flipCard(card) {
      if (card.isMatched || card.isFlipped || this.openedCards.length === 2) return;
      card.isFlipped = true;
      if (this.openedCards.length < 2) this.openedCards.push(card);
      if (this.openedCards.length === 2) this._match(card);
    },
    _match(card) {
...
},{"../styles/app.less":"4q9Z7","../data/data.json":"46bEI","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4q9Z7":[function() {},{}],"46bEI":[function(require,module,exports) {
module.exports = JSON.parse("{\"data\":[1,2,3,4,5,6]}");
...
},{}]},["1hFkf","XPJbz"], "XPJbz", "parcelRequirec65b")
